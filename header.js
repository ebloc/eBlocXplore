...
exports.insertJob = function(val1, var2, var3, var4) {
    hash = myContractInstance.insertJob(val1, var2, var3, var4, {from: web3.eth.defaultAccount, gas: gasLimit, value: 10*1000000000000000 }); 
    console.log( hash );
};
...
exports.add_ipfs = function( var1, var2, var3 ) {
    hash = myContractInstance.add_ipfs(var1, var2, var3, {from: web3.eth.defaultAccount,gas: gasLimit }); 
    console.log( hash );
};

exports.setJobStatus = function( var1, var2, var3 ) {
    hash = myContractInstance.setJobStatus(var1, var2, var3, {from: web3.eth.defaultAccount,gas: gasLimit }); 
    console.log( hash );
};

exports.setJob_IPFS_out = function( var1, var2, var3 ) {
    hash = myContractInstance.setJob_IPFS_out(var1, var2, var3, {from: web3.eth.defaultAccount, gas: gasLimit }); 
    console.log( hash );
};
...
exports.createCluster = function( var1, var2, var3 ) {
    hash = myContractInstance.createCluster(var1, var2, var3, {from: web3.eth.defaultAccount, gas: gasLimit }); 
    console.log( hash );
};
...
exports.setClusterCoreMinutePrice = function( var1, var2 ) {
    hash = myContractInstance.setClusterCoreMinutePrice(var1, var2, {from: web3.eth.defaultAccount, gas: gasLimit }); 
    console.log( hash );
};
